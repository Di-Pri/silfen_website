...
let priceTo = 600;
let priceFrom = 200;
let url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]}}`;
  ...
  if (colors.length > 0) {
    if (material.length > 0) {
      if (category.length > 0) {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"colors":{"$in":[${colorsString}]},"material":{"$in":[${materialString}]},"category":{"$in":[${categoryString}]}}`;
      } else {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"colors":{"$in":[${colorsString}]},"material":{"$in":[${materialString}]}}`;
      }
    } else {
      if (category.length > 0) {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"colors":{"$in":[${colorsString}]},"category":{"$in":[${categoryString}]}}`;
      } else {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"colors":{"$in":[${colorsString}]}}`;
      }
    }
  } else {
    if (material.length > 0) {
      if (category.length > 0) {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"material":{"$in":[${materialString}]},"category":{"$in":[${categoryString}]}}`;
      } else {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"material":{"$in":[${materialString}]}}`;
      }
    } else {
      if (category.length > 0) {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]},"category":{"$in":[${categoryString}]}}`;
      } else {
        url = `https://kea0209-5a57.restdb.io/rest/products?fetchchildren=true&q={"collection":"Snow queen","price_current":{"$bt":[${priceFrom},${priceTo}]}}`;
      }
    }
  }
